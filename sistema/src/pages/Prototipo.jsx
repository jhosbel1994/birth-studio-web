...
const s = {
  ...
  panelCard: { border: `1px solid ${LINE}`, borderRadius: 12, background: CARD, overflow: "hidden", flexShrink: 0 },
  ...
  treeCard: { border: `1px solid ${LINE}`, borderRadius: 12, background: "rgba(255,255,255,0.02)", padding: 10, display: "flex", flexDirection: "column", gap: 3, flexShrink: 0 },
  ...
  logoActivo: { border: "1px dashed rgba(59,130,246,0.42)", borderRadius: 10, background: "rgba(59,130,246,0.05)", padding: "9px 10px", display: "flex", flexDirection: "column", gap: 7, flexShrink: 0 },
  ...
  inspCard: { border: `1px solid ${LINE}`, borderRadius: 12, background: CARD, padding: "11px 12px", flexShrink: 0 },
